...
roof = new Roof (350, 150, 400, 50)

rope1 = new Rope (bob1.body, roof.body, {x:-100, y:0})
rope2 = new Rope (bob2.body, roof.body, {x:-50, y:0})
rope3 = new Rope (bob3.body, roof.body,{x:0, y:0})
rope4 = new Rope (bob4.body, roof.body, {x:+50, y:0})
rope5 = new Rope (bob5.body, roof.body,{x:+100, y:0})
